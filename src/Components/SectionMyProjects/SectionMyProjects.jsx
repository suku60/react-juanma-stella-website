  ...
  <div className="size_main_section main_section_projects">
            ...
            <div className="projects_data">
              ...
              onMouseLeave={()=>showCarousel(false)}>
                ...
                <a href='https://master.d1ccev8u2cmvlp.amplifyapp.com/' target="_blank">deploy</a>
                <p>project name</p>
                ...
                <a href='https://suku60.github.io/pokemon_cafe_bootstraps/' target="_blank">deploy</a>
                ...
                <a href='https://suku60.github.io/robostrike_videogame/' target="_blank">deploy</a>
                ...
                <a href='https://suku60.github.io/ProyectoConsolaBTCFSD0122/' target="_blank">deploy</a>
